	...
	<body>
		...
		<div id="show-item" class="content scaffold-show" role="main">
			...
			<ol class="property-list item">
				...
				<g:if test="${itemInstance?.coinCost}">
				<li class="fieldcontain">
					<span id="coinCost-label" class="property-label"><g:message code="item.coinCost.label" default="Coin Cost" /></span>
					
						<span class="property-value" aria-labelledby="coinCost-label"><g:fieldValue bean="${itemInstance}" field="coinCost"/></span>
